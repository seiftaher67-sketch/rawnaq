  ...
  return (
    <div className="pt-36 pb-20 bg-white">
      ...
      <div className="text-center mb-12">
        <h1 style={{ fontFamily: 'Calibri', fontWeight: 400, fontStyle: 'normal', fontSize: '64px', lineHeight: '100%', letterSpacing: '0%', textAlign: 'center', leadingTrim: 'NONE' }} className="text-4xl font-bold text-[#0F0F0F]">النقابات</h1>
